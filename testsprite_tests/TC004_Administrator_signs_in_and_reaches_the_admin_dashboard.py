...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Admin Login' tab to switch the form to administrator mode so email/password fields can be entered.
        # Admin Login button
        elem = page.get_by_role('button', name='Admin Login', exact=True)
        await elem.click(timeout=10000)
        
        # -> Fill the admin email field with 'example@gmail.com', fill the password field with 'password123', then click the 'Login' button to submit the admin login form.
        # admin text field
